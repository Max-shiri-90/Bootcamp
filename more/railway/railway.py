...
class Trip:
    all_cities = (
        ...
        'Tabriz', 'Tehran', 'Khorramabad', 'Rasht', 'Zahedan', 'Zanjan', 'Sari', 'Semnan', 'Sanandaj',
        'Shahr-e Kord', 'Shiraz', 'Qazvin', 'Qom', 'Karaj', 'Kermanshah', 'Gorgan', 'Mashhad', 'Hamadan',
        'Yasuj', 'Yazd')
    ...
    def origin_city_validation(self, origin_city):
        if origin_city not in self.all_cities:
            raise Exception("This input is not verified")
